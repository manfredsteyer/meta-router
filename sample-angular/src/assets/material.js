(function() {
  ...
  MaterialLayout.prototype.toggleDrawer = function() {
    ...
    var drawerIcon = this.element_.querySelector('.' + this.CssClasses_.ICON);
    ...
    if (this.drawer_.classList.contains(this.CssClasses_.IS_DRAWER_OPEN)) {
      ...
      drawerIcon.innerHTML = 'navigate_before';
    } else {
      this.drawer_.setAttribute('aria-hidden', 'true');
      drawerButton.setAttribute('aria-expanded', 'false');
      drawerIcon.innerHTML = 'reorder';
    }
  };
    ...
    if (this.element_) {
      ...
      if (this.drawer_) {
        ...
        if (!drawerButton) {
          ...
          drawerButtonIcon.innerHTML = 'reorder';
